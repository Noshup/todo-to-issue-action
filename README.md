...
| `ISSUE_IDENTIFIERS` | No | The Tag used to signify that a comment is/to be associated with an issue in Github. Default value is 'TODO', but you can add as many terms as you like, separating each term using the pipe operator. Example: `"TODO|BUG|TESTING"`                                     |
